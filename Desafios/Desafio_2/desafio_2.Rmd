...
dados_limp3 %>% select(MUNIC, porct_profs) %>% 
  kable(caption = "Porcentagem de professores por município em relação ao total de funcionários", 
        col.names = c("Município", "Porcentagem de professores"), digits = 2)
...
Calcule o total do número de professores e a média por escola em cada nível de ensino em cada município (inclua uma tabela)
